(function($) {
    $.fn.sColor = function(d) {
        var f = {
            colors: '',
            colorsHeight: 26,
            curImg: '/laravel/resources/assets/img/cur.png',
            curTop: 0,
            form: 'drag',
            keyEvent: true,
            prevColor: false,
        ...
        if (j > 0) {
            ...
            $('.am-topbar-inverse').css('background-color',E);
            $('.am-topbar-inverse').css('border-color',E);
            $('.am-btn-primary').css('background-color',E);
            $('.am-btn-primary').css('border-color',E);
            $('.am-btn-secondary').css('background-color',E);
            $('.am-btn-secondary').css('border-color',E);
            $('.font-color').css('color',E);
            if (j > 1) {
                if (v) {
                    $(document).keydown(function(e) {
                        ...
                        function() {
                            ...
                            $('.am-topbar-inverse').css('background-color',a);
                            $('.am-topbar-inverse').css('border-color',a);
                            $('.am-btn-primary').css('background-color',a);
                            $('.am-btn-primary').css('border-color',a);
                            $('.am-btn-secondary').css('background-color',a);
                            $('.am-btn-secondary').css('border-color',a);
                            $('.font-color').css('color',a);
                        })
                    })
                }
                if (u == 'click') {
                    ...
                    $(p).droppable({
                        ...
                        over: function(a, b) {
                            ...
                            $('.am-topbar-inverse').css('background-color',c);
                            $('.am-topbar-inverse').css('border-color',c);
                            $('.am-btn-primary').css('background-color',c);
                            $('.am-btn-primary').css('border-color',c);
                            $('.am-btn-secondary').css('background-color',c);
                            $('.am-btn-secondary').css('border-color',c);
                            $('.font-color').css('color',c);
                        },
                        drop: function(a, b) {
                            $(o).animate({
